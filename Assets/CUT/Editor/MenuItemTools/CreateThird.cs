...
namespace DartsGames.Editors
{
    ...
    {
        [MenuItem("DartsGames/CreateThirdObject/Upwards")]
        private static void CreateThirdUpwards() => CreateThirdObject(true);
        [MenuItem("DartsGames/CreateThirdObject/Downwards")]
        private static void CreateThirdDownwards() => CreateThirdObject(false);

        [MenuItem("DartsGames/CreateThirdObject/Upwards", validate = true), MenuItem("DartsGames/CreateThirdObject/Downwards", validate = true)]
